...
from core.tts_backend.elevenlabs_tts import elevenlabs_tts
from core.tts_backend.qwen_tts import qwen_tts
    ...
    for attempt in range(max_retries):
        try:
            ...
            if TTS_METHOD == 'openai_tts':
                ...
                elevenlabs_tts(text, save_as, number, task_df)
            elif TTS_METHOD == 'qwen_tts':
                qwen_tts(text, save_as, number, task_df)
